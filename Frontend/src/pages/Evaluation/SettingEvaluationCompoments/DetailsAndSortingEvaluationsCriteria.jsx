...
import { getListCriteriaByIdEvaluation, updateSortEvaluation } from "~/apis";
...
const DetailsAndSortingEvaluationsCriteria = (props) => {
  const { id } = props;
  ...
  const fetchById = async (id) => {
    setLoading(true);
    const res = await getListCriteriaByIdEvaluation(id);
  ...
  const onFinish = async () => {
    ...
    const res = await updateSortEvaluation({
      evaluationId: id,
...
export default DetailsAndSortingEvaluationsCriteria;
